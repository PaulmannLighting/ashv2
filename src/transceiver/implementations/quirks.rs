...
/// repeatedly by the NCP if the host-sent data was utterly garbage.
///
/// On multi-package requests this may lead to the host receiving the same invalid command response
/// for each sent chunk.
